    ...
    <div className="BookingForm">
      <form action="" method="post" onSubmit={handleSubmit(onSubmit)}>
        ...
        <FormControl sx={{ width: '330px' }}>
          <InputLabel color="success" id="time-label">
            Time
          </InputLabel>
          <Select
        ...
        <FormControl sx={{ width: '330px' }}>
          <InputLabel color="success" id="guest-label">
            Guest
          </InputLabel>
          <Select
        ...
        <FormControl sx={{ width: '330px' }}>
          <InputLabel color="success" id="table-label">
            Table
          </InputLabel>
          <Select
          ...
          >
            ...
            {Tables &&
              Tables.map((table, index) => (
                <MenuItem key={index} value={table.table_no}>
                  {table.table_no}
                </MenuItem>
              ))}
          </Select>
